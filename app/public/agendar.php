...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($nome && $telefone && $endereco) {
        $stmt = $conexao->prepare("INSERT INTO paciente (nome_paciente, telefone_paciente, endereco_paciente, ID_usuario) VALUES (?, ?, ?, ?)");
        $stmt->bind_param("sssi", $nome, $telefone, $endereco, $_SESSION['ID_usuario']);
        $stmt->execute();
        $stmt->close();
    }
}
...
<a href="frequencia.php" class="btn btn-primary">Ver Frequência dos Pacientes</a>
